(function(program, execJS) { execJS(program) })(function(module, exports, require, console) { // DOM
var Element = {};
...
return eval("(EmberRails.precompile.apply(this, [\"<div id='main'>\\n  <div class='block'>\\n    <div class='secondary-navigation'>\\n      <ul class='wat-cf'>\\n        {{#view view.SubNavItemView item=\\\"reports\\\"}}<a {{action gotoReports}}>Reports</a>{{/view}}\\n        {{#view view.SubNavItemView item=\\\"staff\\\"}}<a {{action gotoStaff}}>Staff</a>{{/view}}\\n        {{#view view.SubNavItemView item=\\\"clients\\\"}}<a {{action gotoClients}}>Clients</a>{{/view}}\\n        {{#view view.SubNavItemView item=\\\"services\\\"}}<a {{action gotoServices}}>Services</a>{{/view}}\\n        {{#view view.SubNavItemView item=\\\"products\\\"}}<a {{action gotoProducts}}>Products</a>{{/view}}\\n      </ul>\\n    </div>\\n  </div>\\n</div>\\n\"]))")
}, function(program) {
